...
async def list_stocks_endpoint(
    ...
    industry: Optional[str] = Query(None, description="Filter by industry subcategory"),
    exchange: Optional[str] = Query(None, description="Filter by exchange market (e.g. NASDAQ, NYSE)"),
    min_market_cap: Optional[float] = Query(None, ge=0, description="Minimum market capitalization"),
    max_market_cap: Optional[float] = Query(None, ge=0, description="Maximum market capitalization"),
